'php' folder and 'mvcdapper' folder both have same login and signup page but implement in different way.php folder is with php and connect to database with PDO,mvcdapper
